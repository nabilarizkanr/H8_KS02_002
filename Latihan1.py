...
#print(df_dsn)
#1. Menentukan Proporsi Setiap Kategori
...
#3. Untuk menentukan jumlah ubin gunakan proporsi tiap kategori
...
#4. Membuat Matriks yang menyerupai waffle, dan isi
...
#5. Petakan matriks waffle chart menjadi visual
fig = plt.figure
